...
private const val SQL_CREATE_ENTRIES =
    "CREATE TABLE ${DatabaseContract.Monedas.TABLE_NAME} (" +
            "${BaseColumns._ID} INTEGER PRIMARY KEY," +
            "${DatabaseContract.Monedas.COLUMN_VALUE} TEXT," +
            "${DatabaseContract.Monedas.COLUMN_VALUE_US} TEXT," +
            "${DatabaseContract.Monedas.COLUMN_YEAR} TEXT,"+
            "${DatabaseContract.Monedas.COLUMN_REVIEW} TEXT," +
            "${DatabaseContract.Monedas.COLUMN_ISAVALIABLE} TEXT,"+
            "${DatabaseContract.Monedas.COLUMN_NAME} TEXT,"+
            "${DatabaseContract.Monedas.COLUMN_COUNTRY} TEXT," +
            "${DatabaseContract.Monedas.COLUMN_V} TEXT,"+
            "${DatabaseContract.Monedas.COLUMN_IMGBANDERAPAIS} TEXT,"+
            "${DatabaseContract.Monedas.COLUMN_IMG} TEXT)"
...
private const val SQL_DELETE_ENTRIES =
    "DROP TABLE IF EXISTS ${DatabaseContract.Monedas.TABLE_NAME}"

private const val SQL_BORRAR_DATOS_TABLA=
    "DELETE FROM ${DatabaseContract.Monedas.TABLE_NAME}"
